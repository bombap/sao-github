...
`Python` · **116,503** stars · 26/08/2026
...
`Python` · **59,263** stars · 26/08/2026
...
`Python` · **50,293** stars · 26/08/2026
...
`Python` · **27,319** stars · 26/08/2026
...
`TypeScript` · **14,535** stars · 26/08/2026
...
`TypeScript` · **13,816** stars · 26/08/2026
...
`TypeScript` · **5,175** stars · 26/08/2026
...
Nền tảng SaaS AI short drama với trung tâm sáng tạo, pipeline DramaForge và canvas vô hạn. Dùng để quản lý dự án từ kịch bản, tài sản, phân cảnh đến sinh và ghép video.

*Mô tả gốc:* 短剧平台 AI Short Film  Motion Comic Generation Platform Industrial AI Motion Comic & Video Workbench

`Java` · **3,912** stars · 26/08/2026
...
`JavaScript` · **2,020** stars · 25/08/2026
...
`TypeScript` · **1,839** stars · 25/08/2026
...
`JavaScript` · **1,560** stars · 26/08/2026
...
`TypeScript` · **701** stars · 25/08/2026
...
`JavaScript` · **555** stars · 25/08/2026
...
`JavaScript` · **279** stars · 25/08/2026
...
`C#` · **87** stars · 24/08/2026

### [hazelhu644-collab/tiktok-creator-sop-tool](https://github.com/hazelhu644-collab/tiktok-creator-sop-tool)

Công cụ SOP outreach creator TikTok Shop: theo dõi nhắn tin, gửi sample, tiến độ video và trạng thái hợp tác, có AI soạn tin. Dành cho seller quản lý pipeline collab affiliate hoặc mã giảm giá theo quy trình rõ ràng.

*Mô tả gốc:* AI-powered creator outreach and collaboration platform for TikTok Shop sellers.

`TypeScript` · **86** stars · 25/08/2026

`ai` `automation` `chatgpt` `codex` `creator-crm` `creator-management`
...
`TypeScript` · **79** stars · 25/08/2026
...
`JavaScript` · **41** stars · 25/08/2026
